...
if __name__ == '__main__':
    ...
    predictor.predict_from_files(join('/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/3个肝段有问题/image'),
                                 join('/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/3个肝段有问题/precouinaud'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset003_example/imagesTr/case_00001_0000.nii.gz')])
