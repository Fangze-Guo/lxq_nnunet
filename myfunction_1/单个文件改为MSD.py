...
# 配置路径
source_dir = "/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/3个肝段有问题/image"
output_mapping_file = "/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/3个肝段有问题/image.tsv"
