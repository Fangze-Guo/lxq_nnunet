...
if __name__ == '__main__':
    ...
    output_dir = "/media/dell/T7 Shield/nnunet/AllData/ST/finished/ST_最终入组_96_命名规范化"
    progress_file = '/media/dell/T7 Shield/nnunet/AllData/ST/finished/ST_最终入组_96.json'
    
    # 选择其中一种方式：
    
    # 方式1: 按子文件夹批量处理，每处理10个休息20秒（推荐）
    print("方式1: 按子文件夹批量处理")
    organize_dicom_files_by_subfolders(input_dir, output_dir, progress_file, batch_size=20, sleep_time=20)
