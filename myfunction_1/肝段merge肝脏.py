...
if __name__ == "__main__":
    # 输入和输出路径
    input_directory = "/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/mask/GT_Couinaud"
    output_directory = "/media/dell/T7 Shield/nnunet/AllData/ST/finished/precontrast/mask/GT_liver1"
